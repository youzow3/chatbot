...
struct _ChatbotTrainerInterface
{
  ...
  gboolean (*train) (ChatbotTrainer *trainer, ChatbotMessageArray **data,
                     gsize data_len, GCancellable *cancellable,
                     GError **error);
};

gpointer chatbot_trainer_new (GType type, const gchar *parameter,
                              GError **error);
gboolean chatbot_trainer_train (ChatbotTrainer *trainer,
                                ChatbotMessageArray **data, gsize data_len,
                                GCancellable *cancellable, GError **error);
void chatbot_trainer_train_async (ChatbotTrainer *trainer,
                                  ChatbotMessageArray **data, gsize data_len,
                                  GCancellable *cancellable,
                                  GAsyncReadyCallback callback,
                                  gpointer user_data);
gboolean chatbot_trainer_train_finish (ChatbotTrainer *trainer,
